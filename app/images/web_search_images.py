...
Padrao: micro saia / micro vestido (lingerie so se o usuario pedir).
"""
...
class WebImageSearchService:
    ...
    # Preferencia fixa: micro saia e micro vestido (NAO lingerie)
    STYLE_PACKS = (
                ...
                for item in top:
                    ...
                    try:
                        ...
                        if len(data) < 8000:
                            continue
                        print(
                            f"[DDG] ok bytes={len(data)} score={item.get('score')} "
